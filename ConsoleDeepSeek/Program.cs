...
namespace ConsoleDeepSeek
{
    internal class Program
    {
        ...
        /// None
        /// </returns>
        static void ModelGenerate(Model model, Tokenizer tokenizer, GeneratorParamsArgs generatorParamsArgs, string modelPath, string systemPrompt, string userPrompt, bool interactive, bool verbose)
        {
            // Complete Q&A
            do
            {
        ...
        /// None
        /// </returns>
        static void ModelQA(Model model, Tokenizer tokenizer, TokenizerStream tokenizerStream, GeneratorParamsArgs generatorParamsArgs, GuidanceArgs guidanceArgs, string modelPath, string systemPrompt, string userPrompt, bool interactive, bool verbose)
        {
        ...
        /// None
        /// </returns>
        static void ModelChat(Model model, Tokenizer tokenizer, TokenizerStream tokenizerStream, GeneratorParamsArgs generatorParamsArgs, GuidanceArgs guidanceArgs,
             string modelPath,
             string systemPrompt,
             string userPrompt,
             bool interactive,
